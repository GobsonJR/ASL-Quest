...
export function CelebrationOverlay({
  ...
  return (
    <div className="rounded-[var(--radius-panel)] border border-[var(--color-success)]/30 bg-[var(--color-panel)] p-6 text-center animate-pop">
      <p className="text-sm font-medium text-[var(--color-success)]">Nice work!</p>
      <h2 className="mt-2 font-display text-2xl md:text-3xl">You signed {letter} correctly</h2>
      {outcome.message && <p className="mt-2 text-sm text-[var(--color-mist)]">{outcome.message}</p>}
